  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      ...
      >
        ...
        <p className={`text-xl mt-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'
          }`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className={`p-8 rounded-xl shadow-lg ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'
            }`}
        >
        ...
        >
          ...
          <div className="space-y-6">
            ...
            >
              <div className={`p-3 rounded-lg ${darkMode ? 'bg-teal-500/20' : 'bg-blue-100'
                }`}>
                <HiPhone className={`text-xl ${darkMode ? 'text-teal-400' : 'text-blue-600'
                  }`} />
              </div>
              <div>
                ...
                <a
                  ...
                  className={`text-lg font-semibold transition-colors ${darkMode ? 'text-white hover:text-teal-400' : 'text-gray-900 hover:text-blue-600'
                    }`}
                >
                  +91 6200584954
                </a>
          ...
          <div className="mt-8 pt-6 border-t border-gray-300 dark:border-gray-600">
            <p className={`text-sm font-medium mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'
              }`}>
              Connect with me
            </p>
